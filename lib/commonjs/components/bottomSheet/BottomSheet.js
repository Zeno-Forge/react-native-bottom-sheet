...
const BottomSheetComponent = /*#__PURE__*/(0, _react.forwardRef)(function BottomSheet(props, ref) {
  ...
  const _providedAnimationConfigs = (0, _react.useMemo)(() => {
    if (!animationConfigs) {
      return undefined;
    }
    ...
    if (_reactNativeReanimated.ReduceMotion) {
      ...
      animationConfigs.reduceMotion = _reactNativeReanimated.ReduceMotion.Never;
    }

    return animationConfigs;
  }, [animationConfigs]); //#endregion
  ...
  const preKeyboardIndex = (0, _reactNativeReanimated.useSharedValue)(_constants2.INITIAL_POSITION);
